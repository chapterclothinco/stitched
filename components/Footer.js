    ...
    <footer className="footer">
      <div className="container">
        ...
        <div className="footer-bottom">
          <p>&copy; 2026 Stitched Group LLC. All rights reserved. <Link href="/terms">Terms</Link> &middot; <Link href="/privacy">Privacy</Link></p>
          <div className="footer-social">
            ...
            <a href="https://www.linkedin.com/company/stitched-group" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
